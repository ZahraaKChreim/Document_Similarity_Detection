...
import preprocess
from graph_of_words import GraphOfWords, show_graph, vertex_edge_overlap, graph_similarity, graphs_jaccard_similarity
...
def get_similarity_record1_record2(record1, record2):
    ...
    #graph_cosine_similarity = get_cosine_of_2_sentences(semantically_preprocessed_paragraph1, semantically_preprocessed_paragraph2)
    #print("graph_cosine_similarity:", graph_cosine_similarity)

    # Graph Representation
    graph1 = GraphOfWords(semantically_preprocessed_paragraph_as_list_of_sentences1, window_size=8)
    g1 = graph1.graph
    edges1 = g1.edges()
    #print(g1.nodes(),"\n######################")
    #print(g1.edges(),"\n######################")
    ...
    graph2 = GraphOfWords(semantically_preprocessed_paragraph_as_list_of_sentences2, window_size=8)
    g2 = graph2.graph  
    edges2 = g2.edges()
    #print(g2.nodes(),"\n######################")
    #print(g2.edges())
    ...
    # print("graph jacc sim:", graph_sim)
